...
To demonstrate this disparity, we looked to data on the ratio of women to men in movie casts in relation to the gross profit from films’ opening weekends and IMDb ratings corresponding to these films. We found that across the board, men are overrepresented in both the top grossing films and top rated IMDb films.
...
The movies with the lowest ratios of women to men are mostly war or adventure movies–typically marketed toward men. Movies like *Fury*, *Pirates of the Caribbean: Curse of the Black Pearl*, and *Dunkirk*  include violence, and are 85% to 95% male, which is not a ratio that reflects the U.S. population. Whereas movies like *Lala Land*, *The Help*, and *Fifty Shades of Grey*–movies that are typically marketed toward women–have more realistic ratios of women to men, at 48% to 51% male.
...
### Below are the average as well as the five movies with the lowest and highest ratio of women to men from the top 100 grossing movies:
```{r, warning=FALSE, message=FALSE}
gender_gross %>%
...
### Below are average as well as the five movies with the lowest and highest ratio of women to men from the top 100 IMDb rated movies:
```{r}
gendervotes %>%
  summarize(average_f = mean(ratiof))
gendervotes %>%
